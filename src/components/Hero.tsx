...
export default function Hero() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Calendar reminder set:', formData);
          ...
          >
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email for Reminders</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
                ...
                <div className="flex items-center text-sm text-gray-600 mt-4">
                  ...
                  <p>You'll receive email reminders 1 week and 2 days before the date</p>
                </div>
